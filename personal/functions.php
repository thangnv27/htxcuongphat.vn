...
*/
    ...
    wp_enqueue_script( SHORT_NAME . '-jquery-migrate', get_template_directory_uri() . '/js/jquery-migrate.min.js', array( 'jquery' ), false, true );
    wp_enqueue_script( SHORT_NAME . '-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery' ), false, true );
    wp_enqueue_script( SHORT_NAME . '-jquery-validate', 'http://ajax.aspnetcdn.com/ajax/jquery.validate/1.16.0/jquery.validate.min.js', array( 'jquery' ), false, true );
    ...
    wp_enqueue_script( SHORT_NAME . '-flexslider', get_template_directory_uri() . '/js/jquery.flexslider-min.js', array( 'jquery' ), false, true );
    wp_enqueue_script( SHORT_NAME . '-colorbox', get_template_directory_uri() . '/colorbox/jquery.colorbox-min.js', array( 'jquery' ), false, true );
    wp_enqueue_script( SHORT_NAME . '-wow', get_template_directory_uri() . '/js/wow.min.js', array( 'jquery' ), false, true );
    if(is_singular('photo')){
        wp_enqueue_script( SHORT_NAME . '-refineslide', get_template_directory_uri() . '/js/jquery.refineslide.min.js', array( 'jquery' ), false, true );
    }
//    wp_enqueue_script( SHORT_NAME . '-disable-copy', get_template_directory_uri() . '/js/disable-copy.js', array( 'jquery' ), false, true );
    wp_enqueue_script( SHORT_NAME . '-custom', get_template_directory_uri() . '/js/custom.js', array( 'jquery' ), false, true );
    wp_enqueue_script( SHORT_NAME . '-script', get_template_directory_uri() . '/js/app.js', array( 'jquery' ), false, true );
    if(!is_admin()){
